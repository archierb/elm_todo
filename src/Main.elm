...
view model =
    div [ class "main" ]
        [ div [ class "addTask"]
                [
                    input [class "addTaskInput" ,type_ "text" ,placeholder "task" , onInput Add , value model.newTask.taskName] [],
                    button [ class "addTaskButton",onClick Submit ] [text "addition"]
        ,div [ class "todoList" ]
            [
...
viewItem task =
    li [] [
        text task.taskName,
        button [class "addTaskButton",onClick (Delete task.taskName)] [text "delete"],
        hr [] []
    ]
